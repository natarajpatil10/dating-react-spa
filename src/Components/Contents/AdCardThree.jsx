		...
		<>
			<div className="adCard  p-0 d-flex flex-wrap justify-content-between align-items-start my-3" style={style}>
				<div className="mt-2 col-md-3 col-12 mr-2">
					<img src="https://images.top10.com/f_auto,q_auto/v1/production/partners/uploads/photo/eharmony-logo.20181021064915.png" alt="" style={{ minWidth: "3rem", height: "2.5rem" }} />
				</div>
