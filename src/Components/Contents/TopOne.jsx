			...
			<div className="carousel mb-5">
				<Carousel interval={null}>
					<Carousel.Item >
						<img
							...
							src="https://images.unsplash.com/photo-1513279922550-250c2129b13a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
							alt="First slide"
						/>
					</Carousel.Item>
					<Carousel.Item >
				...
				<div className="my-4 d-flex flex-wrap justify-content-between align-content-center">
					<div className="py-2 col-sm-9 col-12 p-0">
						<a href="a" className="read-review-link">
							Read Zoosk Review <BsArrowRight />
						</a>
					</div>
				...
				<div className="bg-light my-5 d-flex justify-content-between align-content-center">
					...
					<div className="d-flex align-align-items-center ">
						<button className="btn visit-site-btn w-100">Visit Site</button>
					</div>
				</div>
				<hr />
			</div>
