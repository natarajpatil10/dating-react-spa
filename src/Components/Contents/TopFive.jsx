		...
		<div className="" id="silverSingles">
			...
			<div className="carousel mb-5">
				<Carousel interval={null}>
					<Carousel.Item>
						<img
							...
							src="https://images.unsplash.com/photo-1565870100382-f0a510db3cd1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1189&q=80"
							alt="Second slide"
						/>
					</Carousel.Item>
					<Carousel.Item>
				...
				<div className="my-4 d-flex flex-wrap justify-content-between align-content-center">
					<div className="py-2">
						<a href="a" className="read-review-link col-sm-9 col-12 p-0">
							Read SilverSingles Review <BsArrowRight />
						</a>
					</div>
